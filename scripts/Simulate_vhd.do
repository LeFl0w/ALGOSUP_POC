...
vcom -work work -2008 ../Project/routed_POC.vhd

#compile testbench
#vlog ../src/flipflop_tb.v
vcom -work work -2008 ../src/flipflop_tb.vhd
...
#launch simulation
vsim -voptargs=+acc -t 1ps -lib work -sdfmax dut=$currentloc/../Project/routed_POC_worst.sdf work.flipflop_tb 
